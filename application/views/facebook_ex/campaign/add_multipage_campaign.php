...
<script>
	...
	$j("document").ready(function(){
	    ...
	    $(document.body).on('click','#submit_test_post',function(){ 
	    	...
	    	{
	    		alert(pleasechooseanyleadtosendtestmessage);
	    	 	return;
	    	}
    		...
    		{
    			alert(messageorpasteurlvideourlsystemcannotsendblankmessage);
    			return;
    		} 
    	    $("#test_loading").show();
	    ...
	    $(document.body).on('click','#submit_post',function(){ 
        	...
        	if(inbox_to_pages==null)
        	{
        		alert(pleaseselectpagestocreateinboxcampaign);
        		return;
        	}
